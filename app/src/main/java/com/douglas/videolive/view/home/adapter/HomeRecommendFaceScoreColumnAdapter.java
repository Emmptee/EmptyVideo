 ...
 **/
public class HomeRecommendFaceScoreColumnAdapter extends
...
//          this.mHomeFaceScoreColumn.clear();
    ...
    private void bindFaceScoreHolder(FaceScoreColumnHolder holder, int position) {
        ...
        holder.tv_column_item_nickname.setText(
                mHomeFaceScoreColumn.get(position).getNickname());
        holder.tv_online_num.setText(CalculationUtils.getOnLine
                (mHomeFaceScoreColumn.get(position).getOnline()));
        holder.tv_facescore_city.setText(
                mHomeFaceScoreColumn.get(position).getAnchor_city());

        holder.img_item_gridview.setOnClickListener(
